...
class SkillPage extends Component {
  ...
  render() {
	...
	const showIcon = get(Meteor.user(), 'profile.curating', []).includes(props.skillId)
    ...
    return props.loaded ? (
		<section>
	        <Row className="section row">
	            <Col s={12} className="card-panel">
	                <div style={{overflow: 'auto', paddingTop: 15}}>
	                  <div onClick={_toggleEdit.bind(this)} className="fixed-action-btn" style={{bottom: '45px', right: '24px'}}>
	                  ...
	                  <a className="waves-effect waves-blue btn-flat left" title="подписаться" onClick={toggleCurating.bind(this)}>
	        ...
	        {state.edit ? <SkillsUpdate revision={props.revision} callback={_skillUpdated.bind(this)} /> : <SkillStages text={props.revision.text} />}
	        ...
	        <List
	          ...
	          onChangePage={changePage.bind(this)}
			/>
		</section>
    ) : <Loading />
  }
